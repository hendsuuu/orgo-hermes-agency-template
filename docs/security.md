...
Use a distinct Telegram bot token, Composio entity, and least-privilege tool
...
inline Telegram approval. Timeout, missing UI, or plugin exception fails closed.
